...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--pretrained_ckpt_path', default=None, type=str, help='Path to pretrained pSp model checkpoint')
        ...
        self.parser.add_argument('--mmd', action="store_true", help="if to use multimodal")
        self.parser.add_argument('--modes', default=10, type=int, help='number of modes')
